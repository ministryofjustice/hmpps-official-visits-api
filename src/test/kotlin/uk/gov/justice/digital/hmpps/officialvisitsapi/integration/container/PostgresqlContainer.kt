package uk.gov.justice.digital.hmpps.officialvisitsapi.integration.container
...
object PostgresqlContainer {
  ...
  private fun startPostgresqlIfNotRunning(): PostgreSQLContainer<Nothing>? {
    ...
    return PostgreSQLContainer<Nothing>("postgres:16").apply {
      ...
      withDatabaseName("official-visits-test-db")
      withUsername("official-visits")
      withPassword("official-visits")
