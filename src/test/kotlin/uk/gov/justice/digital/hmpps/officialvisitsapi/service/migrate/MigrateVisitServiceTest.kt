  ...
  inner class Visit {
    ...
    private fun visitorEntities(request: MigrateVisitRequest, visit: OfficialVisitEntity) = listOf(
      OfficialVisitorEntity(
        ...
        relationshipTypeCode = request.visitors[0].relationshipTypeCode,
        relationshipCode = request.visitors[0].relationshipToPrisoner,
      ...
      OfficialVisitorEntity(
        ...
        prisonerContactId = null,
        relationshipTypeCode = request.visitors[1].relationshipTypeCode,
        relationshipCode = request.visitors[1].relationshipToPrisoner,
