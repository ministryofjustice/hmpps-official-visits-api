...
data class MigrateVisitConfigRequest(
  ...
  @field:NotNull(message = "The prison code for a visit timeslot is mandatory")
  @Schema(description = "The 3-letter agy_loc_id from NOMIS where this visit time slot exists", example = "MDI", required = true)
  val prisonCode: String? = null,

  @field:NotNull(message = "The day code for a visit timeslot is mandatory")
  ...
  @field:NotNull(message = "The time slot sequence for a visit timeslot is mandatory")
  ...
  @field:NotNull(message = "The start time for a visit timeslot is mandatory")
  @Schema(description = "The start time for this visit timeslot", example = "13:30", required = true)
  @JsonFormat(pattern = "HH:mm")
  val startTime: LocalTime? = null,

  @field:NotNull(message = "The end time for a visit timeslot is mandatory")
  @Schema(description = "The end time for this visit timeslot", example = "14:30", required = true)
  @JsonFormat(pattern = "HH:mm")
  val endTime: LocalTime? = null,

  @field:NotNull(message = "The effective date for a visit timeslot is mandatory")
  ...
  @Schema(description = "The list of visit slots which are linked to this timeslot")
...
data class MigrateVisitSlot(
  ...
  @Schema(description = "The maximum number of groups who can book into this visit slot. Effectively, the max visits limit for the slot.", example = "8", required = true)
  val maxGroups: Long? = null,

  @field:NotNull(message = "The maximum number of adults who can attend this visit slot is mandatory.")
  @Schema(description = "The maximum number of adults, across visits, that who can book into this visits slot.", example = "22", required = true)
  val maxAdults: Long? = null,

  @Schema(description = "The maximum number of adults, across visits, that who can book into this visits slot.", example = "8", nullable = true, required = false)
  val maxVideoSessions: Long? = null,
