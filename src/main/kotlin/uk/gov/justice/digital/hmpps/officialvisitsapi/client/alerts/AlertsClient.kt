...
@Component
class AlertsClient(private val alertsApiHealthWebClient: WebClient) {
  companion object {
    private val log = LoggerFactory.getLogger(this::class.java)
  }

  fun getPrisonerAlerts(prisonerNumber: String): List<Alert> = alertsApiHealthWebClient
    .get()
    .uri("/prisoner/{prisonerNumber}/alerts", prisonerNumber)
    .retrieve()
    .bodyToMono(typeReference<PageAlert>())
