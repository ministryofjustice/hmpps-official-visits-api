...
FEATURE_EMAIL_NOTIFICATIONS_PRISONS=$(kubectl -n "$OV_NAMESPACE" get secret feature-toggles -o jsonpath='{.data.FEATURE_EMAIL_NOTIFICATIONS_PRISONS}' | base64 -d)
...
FEATURE_VISITS_NEED_REVIEW_PRISONS=$(kubectl -n "$OV_NAMESPACE" get secret feature-toggles -o jsonpath='{.data.FEATURE_VISITS_NEED_REVIEW_PRISONS}' | base64 -d)
...
echo FEATURE_EMAIL_NOTIFICATIONS_PRISONS="${FEATURE_EMAIL_NOTIFICATIONS_PRISONS:-missing}"
...
echo FEATURE_VISITS_NEED_REVIEW_PRISONS="$FEATURE_VISITS_NEED_REVIEW_PRISONS"